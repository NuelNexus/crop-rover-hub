...
const STORAGE_KEY = "hqi_onboarding_v1";
const STEP_KEY = "hqi_onboarding_step";
...
const OnboardingGuide = () => {
  ...
  const steps = useMemo<TourStep[]>(
    () => [
      {
        title: "Welcome to Harvest IQ",
        body: "I will guide you through each tab. Use Next to jump around.",
        path: "/",
      },
      {
        title: "Dashboard",
        body: "Real-time farm health and KPIs live here.",
        path: "/dashboard",
      },
      {
        title: "Analytics",
        body: "Trends, charts, and insights across your operation.",
        path: "/analytics",
      },
      {
        title: "Crops",
        body: "Track crop stages, progress, and tasks.",
        path: "/crops",
      },
      {
        title: "AI Analysis",
        body: "Get AI-assisted recommendations and diagnostics.",
        path: "/ai-analysis",
      },
      {
        title: "CropRover",
        body: "Control the rover and view missions.",
        path: "/croprover",
      },
      {
        title: "Camera Feed",
        body: "Live video and snapshots from the field.",
        path: "/camera-feed",
      },
      {
        title: "ESP32 Devices",
        body: "Manage sensors and device status.",
        path: "/esp32",
      },
      {
        title: "Storage",
        body: "Monitor bins and storage conditions.",
        path: "/storage",
      },
      {
        title: "Harvesting",
        body: "Plan and log harvest activity.",
        path: "/harvesting",
      },
      {
        title: "Finances",
        body: "Expenses, revenue, and farm budgeting.",
        path: "/finances",
      },
      {
        title: "Marketplace",
        body: "Buy or sell supplies and produce.",
        path: "/marketplace",
      },
      {
        title: "Messages",
        body: "Team and partner communication.",
        path: "/messages",
      },
      {
        title: "Traceability",
        body: "Compliance and crop tracing records.",
        path: "/traceability",
      },
      {
        title: "Weather",
        body: "Local forecasts and alerts.",
        path: "/weather",
      },
      {
        title: "Settings",
        body: "Profile, preferences, and system setup.",
        path: "/settings",
      },
    ],
    []
  ...
  useEffect(() => {
    ...
    if (savedStep) {
      ...
      if (!Number.isNaN(parsed)) {
        setStepIndex(Math.min(Math.max(parsed, 0), steps.length - 1));
      }
    }
    if (!seen) {
      setIsActive(true);
  ...
  }, [isActive, location.pathname, navigate, stepIndex, steps]);
  ...
  return (
    <div className="onboard-overlay" role="dialog" aria-modal="true" aria-label="Onboarding tour">
      <div className="onboard-surface">
        <div className="onboard-card">
          <div className="onboard-header">
            <div className="onboard-title">{step.title}</div>
            <div className="onboard-step">Step {stepIndex + 1} of {steps.length}</div>
          </div>
          <p className="onboard-body">{step.body}</p>
          <div className="onboard-actions">
            <button className="onboard-btn ghost" onClick={handleSkip}>Skip</button>
            <div className="onboard-actions-right">
              <button className="onboard-btn ghost" onClick={handleBack} disabled={stepIndex === 0}>Back</button>
        ...
        <div className="onboard-character" aria-hidden="true">
          <svg
            id="onboarding-walle"
          ...
          <div className="onboard-badge">Your guide</div>
        </div>
      </div>
    </div>
  );
